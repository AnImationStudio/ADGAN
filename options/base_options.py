...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--loadSize', type=int, default=44, help='scale images to this size')
        self.parser.add_argument('--fineSize', type=int, default=44, help='then crop to this size')
